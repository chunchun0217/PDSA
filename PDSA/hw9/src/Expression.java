...
//        }
    ...
    public void EvalutionRec() {
        ArrayList<Node> list = new ArrayList<>();
        Stack<Node> s = new Stack<>();
//        Node point = root;

        System.out.println(EvalutionHelper(root));


    }

    private double EvalutionHelper(Node point) {
//        s.push(point);
        if (point.getValue().equals("+")) {
            return EvalutionHelper(point.getLeft()) + EvalutionHelper(point.getRight());
        } else if (point.getValue().equals("-")) {
            return EvalutionHelper(point.getLeft()) - EvalutionHelper(point.getRight());
